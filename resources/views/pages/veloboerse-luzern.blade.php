...
<div class="banner-wrapper">
	<img class="banner-image" src="{{asset('assets/img/banner-veloboerse-luzern.jpg')}}" alt="Veloboerse Luzern Banner" />
	<h1 class="banner-title title-luzern">
		<p class="banner-sub-title">Let's race!</p>
		Velobörse. Olten!
	</h1>
