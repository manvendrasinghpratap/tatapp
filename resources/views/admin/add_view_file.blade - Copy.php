...
<div class="clearfix"></div>
 <div class="section" > 
    ...
    <section class="content-header">
      <h3>@if(@$request->id){{'Assign Case to Task '}} @else {{'Manage Files'}} @endif </h3>
      <ol class="breadcrumb">
                        ...
                        <div class="modal-body sectortbl111">
                              <div class="row">
                                  ...
                                  <div class="col-sm-4" class="float-sm-right"> 
                                             <button type="button" class="btn btn-primary pull-right" id="addFilebtn" onclick="addFileDetails(0,45,'{{route('admin-ajaxEditFileDetails')}}');">Add file</button>
                                   </div>
                              </div><br>
                        </div>
                    </div>
