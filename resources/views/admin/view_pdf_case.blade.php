...
<div class="spacer7"></div>               
			   <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <input type="text" name="title" id="title" class="form-control" placeholder="Title" disabled  value="{{@$data['caseDetails']->title}}">
                        </div>
                    </div>
					 <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group"><select name="urgency" class="form-control" id="urgency" disabled>
                                            <option value="">Select</option>
                                            <?php for($i=1;$i<6;$i++){ ?>
            ...
            ?>
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <select name="case_owner_id1" class="form-control" id="case_owner_id1" disabled>
                            <option value="">Select</option>
              ...
              <!--<div id="container"></div>-->
					...
					<div class="profile-image-inner-button">
                       ...
                       <?php
						...
						<div class="profile-image-inner-button-right">
						 <button class="btn btn-default" style="width:100%;" id="genPDF">Generate PDF</button>
						</div>
						</div>
					</figcaption>
					<figcaption>
...
<div class="row">
    ...
    <table id="taskList" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            @foreach($data['getAllTaskByCaseId'] as $row)   
            ...
            <tr>
               ...
               <td>
                                    ...
                                    <a href="javascript:open_task_modal(<?php echo $row->id; ?>, <?php echo $row->case_id; ?>);" class="btn btn-info btn-xs action-btn" title ="Edit"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                    <a href="javascript:void(0);" class="btn btn-danger btn-xs action-btn" onclick="delete_task(<?php echo $row->id; ?>);" title ="Delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                    </td>
                               <?php } ?>
	...
	<div class=" pull-left">
         <a href="javascript:void(0);" class="btn btn-primary addTask" title="Add Task"><i class="fa fa-plus"></i></a>
...
<div class="row">
    <div class="col-sm-12" id="ajaxresp">
        <div class="table-responsive">
   <div id="note_add"><form action="javascript:void(0);" method="post" id="add_note_frm">
   <div class="note_add_input_content"><input type="text" placeholder="Add Note" name="add_note" class="note_add_input"><input type="hidden" name="case_id" value="<?php echo $data['caseList']->id; ?>"></div><div class="note_add_button"><button type="submit" class="btn btn-info btn-xs action-btn">Add</button></div></form></div>
            ...
            @foreach($data['add_note'] as $row)  
				...
				@if(@$data['caseList']->default_pic!='')
						...
						<div class="note_add_message_previous_content"> 	<div class="note_add_previous">
						...
						</div><?php $rowscnt=count($data['add_note']);?>
						<div class="note_add_out">2 out of <?php echo $rowscnt;?></div></div>
						</div>
						</div>
					@else
                    @endif
...
<div class="row">
	...
	<div class=" pull-left">
         <a id="addrow" href="{{route('admin-linkreportToIncident',['id'=>@$data['caseList']->id,'type'=>'case'])}}" class="btn btn-primary " title="Add Incident"><i class="fa fa-plus"></i></a>
