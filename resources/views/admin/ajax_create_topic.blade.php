            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <div class="mdl-ipt-ovt">                      
                        ...
                        <div class="form-group">
                            <textarea rows="5" cols="20" type="text" id="messageboxcontent" name="messageboxcontent" placeholder="Description"/></textarea>
                        </div>
                         <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger hidden" id="deleteTopic">Delete Topic</button>
                    <button type="button" class="btn btn-primary btn-info" id="saveTopic">Save changes</button>
