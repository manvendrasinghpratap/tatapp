            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        @endif
                        <form id="user-mng" method="get" action="{{route('admin-targetList')}}">
                            {{ csrf_field() }}
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a href="{{route('admin-targetList')}}" class="btn btn-primary btn-success">{{_i('Reset')}}</a>
                                    <div class="col-sm-2 pull-right">
                                    <a href="{{route('admin-addTargetInCase')}}" class="btn btn-block btn-warning">Add Target</a>
                                    </div>
                                </div>
                            </div>
                        </form>
