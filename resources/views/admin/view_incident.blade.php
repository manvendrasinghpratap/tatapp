...
<div class="clearfix"></div>
 <div class="section" >
    ...
    <section class="content-header">
      <h3>@if(@$data->id){{' View '}} @else {{'Add'}} @endif Incident</h3>
      <ol class="breadcrumb">
        <li><a href="{{route('admin-dashboard')}}"><i class="fa fa-tachometer-alt"></i> {{_i('Home')}}</a></li>
        <li class="active">@if(@$data->id){{'View'}} @else {{'Add'}} @endif Incident</li>
      </ol>
    </section>
				...
				<div class="box-body">
					...
					<div class="form-group">
						  ...
						  <div class="col-sm-6">
							  ...
							  <textarea disabled  class="form-control btnSub btnSub" id="incident_type_desc" name="incident_type_desc" placeholder="Incident Description"></textarea>
						  </div>
					</div>
              ...
              <input type="hidden" name="id" value="{{old('id',@$data->id)}}">
                <div class="form-group row @if($errors->first('title')) {{' has-error has-feedback'}} @endif ">
                 ...
                 <div class="form-group row @if($errors->first('description')) {{' has-error has-feedback'}} @endif ">
                  ...
                  <div class="col-sm-9">
				  <textarea disabled disabled name="description" placeholder="Description" id="description" class="md-textarea form-control" rows="3" >{{old('name',@$data->description)}}</textarea>
 ...
 $(".dyncDataTable .add_more_records").on("click", function () {
		...
		cols += '<textarea disabled name="victim_name_and_contact_info[contact_info][]" placeholder="Contact Info" id="victim_name_and_contact_info" class="md-textarea form-control add_more_text" rows="3"></textarea>';
 ...
 $(".dyncDataTable2 .add_more_records").on("click", function () {
		...
		cols +=  '<textarea disabled name="persons_of_concern_name_and_contact_info[contact_info][]" placeholder="Contact Info" id="persons_of_concern_name_and_contact_info" class="md-textarea form-control add_more_text" rows="3"></textarea>';
        cols += '<input type="button" style="width:9%" class="ibtnDelRow btn btn-md btn-danger"  value="-">';
		cols += '</div>';
 ...
 $(".dyncDataTable3 .add_more_records").on("click", function () {
		...
		cols += '<textarea disabled name="witnesses_names_and_contact_info[contact_info][]" placeholder="Contact Info" id="witnesses_names_and_contact_info" class="md-textarea form-control add_more_text" rows="3"></textarea>';
		cols += '<input type="button" style="width:9%" class="ibtnDelRow btn btn-md btn-danger"  value="-">';
		cols += '</div>';
      ...
      <!--  <button id="modalBt" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Add New Incident Type</button>-->
                ...
                <span class="input-group-addon " style=""><i class="fa fa-calendar "></i></span>
                 ...
                 <div class="form-group row @if($errors->first('location')) {{' has-error has-feedback'}} @endif ">
                  ...
                  <div class="col-sm-9">
                      <textarea disabled name="location" placeholder="Location" id="location" class="md-textarea form-control" rows="3" >{{old('name',@$data->location)}}</textarea>
				...
				<div class="form-group row @if($errors->first('medical_assistance_required')) {{' has-error has-feedback'}} @endif ">
				 ...
				 <div class="form-group row @if($errors->first('follow_up_actions')) {{' has-error has-feedback'}} @endif ">
                  ...
                  <div class="col-sm-9">
                      <textarea disabled name="follow_up_actions" placeholder="Follow up Actions" id="follow_up_actions" class="md-textarea form-control" rows="3" >{{old('name',@$data->follow_up_actions)}}</textarea>
				 ...
				 <input type="text" name="victim_name_and_contact_info[victim_name][]" id="victim_name" class="form-control add_more_text" placeholder="Victim Name" value="{{old('name',@$victim_name_and_contact_info_victim_name)}}">
				   <textarea disabled name="victim_name_and_contact_info[contact_info][]" placeholder="Contact Info" id="victim_name_and_contact_info" class="md-textarea form-control add_more_text" rows="3">{{old('name',@$victim_name_and_contact_info_contact_info)}}</textarea>
				   <?php if($count==0){?>
				...
				<input type="text" name="victim_name_and_contact_info[victim_name][]" id="victim_name" class="form-control add_more_text" placeholder="Victim Name" value="">
				   <textarea disabled name="victim_name_and_contact_info[contact_info][]" placeholder="Contact Info" id="victim_name_and_contact_info" class="md-textarea form-control add_more_text" rows="3"></textarea>
					<input type="button"  value="+" style="width:9%" class="btn btn-primary btn-info add_more_records">
				</div>
				<?php }?>
                <?php 
                ...
                ?>                  
				 ...
				 <textarea disabled name="persons_of_concern_name_and_contact_info[contact_info][]" placeholder="Contact Info" id="persons_of_concern_name_and_contact_info" class="md-textarea form-control add_more_text" rows="3">{{old('name',@$persons_of_concern_name_and_contact_info_contact_info)}}</textarea>				
				   <?php if($count==0){?>
					<input type="button"  value="+" style="width:9%" class="btn btn-primary btn-info add_more_records">
					<?php }else{?>
					<input type="button" style="width:9%" class="ibtnDelRow btn btn-md btn-danger"  value="-">
				...
				<div class="dyncDataTableRow">
				 <input type="text" name="persons_of_concern_name_and_contact_info[person_name][]" id="person_name" class="form-control add_more_text" placeholder="Person Name" value="">
				   <textarea disabled name="persons_of_concern_name_and_contact_info[contact_info][]" placeholder="Contact Info" id="persons_of_concern_name_and_contact_info" class="md-textarea form-control add_more_text" rows="3"></textarea>	
					<input type="button"  value="+" style="width:9%" class="btn btn-primary btn-info add_more_records">
				</div>
				<?php }?>
                  </div>
				...
				if(!empty($witnesses_names_and_contact_info_value)&&count($witnesses_names_and_contact_info_value)>0){
				 ...
				 <input type="text" name="witnesses_names_and_contact_info[witness_name][]" id="witness_name" class="form-control add_more_text" placeholder="Witness Name" value="{{old('name',@$witnesses_names_and_contact_info_witness_name)}}">			 
				   <textarea disabled name="witnesses_names_and_contact_info[contact_info][]" placeholder="Contact Info" id="witnesses_names_and_contact_info" class="md-textarea form-control add_more_text" rows="3">{{old('name',@$witnesses_names_and_contact_info_contact_info)}}</textarea>
				   <?php if($count==0){?>
					<input type="button"  value="+" style="width:9%" class="btn btn-primary btn-info add_more_records">
					<?php }else{?>
					<input type="button" style="width:9%" class="ibtnDelRow btn btn-md btn-danger"  value="-">
				...
				<input type="text" name="witnesses_names_and_contact_info[witness_name][]" id="witness_name" class="form-control add_more_text" placeholder="Witness Name" value="">	
				   <textarea disabled name="witnesses_names_and_contact_info[contact_info][]" placeholder="Contact Info" id="witnesses_names_and_contact_info" class="md-textarea form-control add_more_text" rows="3"></textarea>
					<input type="button"  value="+" style="width:9%" class="btn btn-primary btn-info add_more_records">
				</div>
				<?php }?>
                  </div>
              ...
              <!-- /.box-body -->
              <div class="box-footer form-group row col-sm-6" style="float: right;">
                <a href="{{route('admin-incidentList')}}" class="btn btn btn-primary">Close</a>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
          ...
          <div class="col-sm-12" id="ajaxresp">
              <div class="table-responsive">
                    <table class="table table-hover" id="printTable">
                          ...
                          @else
                          <tr class="bg-info">
                          <td colspan="7">Record(s) not found.</td>
                          </tr>
                          @endif
                    </table>
                </div>
