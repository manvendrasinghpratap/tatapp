...
<!-- Trigger the modal with a button -->
            ...
            <div class="modal-dialog" role="document">
				...
				<div class="modal-body"> 
                    ...
                    <div class="inner-div" style="padding:10px">
                        ...
                        <input disabled type="text" id="title" name="title" placeholder="Title" value="<?php echo @$title?>" class="form-control input-sm"/><br/>
                        <div>
                            <select id="rank_id" name="rank_id" class="form-control input-sm" disabled>
 ...
 <div id="SectorDiv">
			...
			<select id="sector_id" name="sector_id" class="form-control input-sm" disabled>
			<option value="">Sector</option>
			 <?php 
                ...
                ?>
                        ...
                        <br/>
                         <input disabled type="text" id="source" placeholder="Source" name="source"  class="form-control input-sm" value="<?php echo @$source?>"/><br/><br/>
                         Occurence Date: <br/><input disabled type="text" id="occurance_date" class="datespicker1 form-control input-sm" name="occurance_date" value="<?php echo @$occurance_date?>"/> <span class="add-on"><i class="icon-calendar" id="cal"></i></span><br/><br/>  
					   <?php 
            $allowRolesList = array("agencySuperAdmin", "agencyAdmin", "agencyUser");
            $user_role_name = Session::get('user_role_name');?>
                        <input disabled type="checkbox" id="target_chart_visibility"  name="target_chart_visibility" <?php if(@$target_chart_visibility=='y')echo 'checked=checked';?>/> Show on Target Chart? <br/><br/>
                        <input disabled type="checkbox" id="timeline_chart_visibility"  name="timeline_chart_visibility" <?php if(@$timeline_chart_visibility=='y')echo 'checked=checked';?> /> Show on timeline? <br/><br/>
						Chart Icon: <br/>  <select id="chart_icon" name="chart_icon" class="form-control input-sm" disabled>
					...
					<?php if(empty($v)){ ?>
                        ...
                        <br/><br/>
                        <textarea disabled class="form-control input-sm" type="text" id="description" style="height:100px;" name="description" placeholder="Description"><?php echo @$description?></textarea><br/>
                    </div>
