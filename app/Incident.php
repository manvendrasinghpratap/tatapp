...
class Incident extends Model 
{
  ...
  function getAllVisibleTimeLineDataByCaseId($caseId){
   ...
   function getTaskDetails($task_id)
    ...
    {
        return $this->hasOne('App\IncidentToGroup','incident_id','id')->select('*');
    }

    function incident(){
         return $this->hasMany('App\TaskIncident','incident_id');
    }
    function incidentType(){
    return $this->belongsTo('App\IncidentType','type','id');
    }
